...
if __name__ == '__main__':
    ...
    logging.info("Script execution is complete. Terminating all of the Branch Processes")
    for process in branch_processes:
        process.terminate()
    logging.info("You can find the output in `customer_output.json` file in this directory")